package dev.hectorolea.food.ordering.system.service.domain;
...
import dev.hectorolea.food.ordering.system.order.service.dataaccess.outbox.payment.entity.PaymentOutboxEntity;
import dev.hectorolea.food.ordering.system.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import dev.hectorolea.food.ordering.system.order.service.domain.OrderPaymentSaga;
import dev.hectorolea.food.ordering.system.order.service.domain.OrderServiceApplication;
...
public class OrderPaymentSagaTest {
  ...
  private final UUID ORDER_ID = fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb17");
  private final UUID CUSTOMER_ID = fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb41");
  private final UUID PAYMENT_ID = randomUUID();
  ...
  private void assertPaymentOutbox() {
    Optional<PaymentOutboxEntity> paymentOutboxEntity =
        paymentOutboxJpaRepository.findByTypeAndSagaIdAndSagaStatusIn(
            ORDER_SAGA_NAME, SAGA_ID, of(SagaStatus.PROCESSING));
  ...
  private PaymentResponse getPaymentResponse() {
    return PaymentResponse.builder()
        ...
        .paymentStatus(
            dev.hectorolea.food.ordering.system.domain.valueobject.PaymentStatus.COMPLETED)
