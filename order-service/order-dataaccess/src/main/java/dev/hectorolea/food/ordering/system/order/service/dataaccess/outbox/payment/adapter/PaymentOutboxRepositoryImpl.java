package dev.hectorolea.food.ordering.system.order.service.dataaccess.outbox.payment.adapter;

import static java.util.Arrays.asList;

import dev.hectorolea.food.ordering.system.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import dev.hectorolea.food.ordering.system.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
  ...
  public OrderPaymentOutboxMessage save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
    return paymentOutboxDataAccessMapper.paymentOutboxEntityToOrderPaymentOutboxMessage(
        paymentOutboxJpaRepository.save(
            paymentOutboxDataAccessMapper.orderPaymentOutboxMessageToOutboxEntity(
    ...
    return Optional.of(
        paymentOutboxJpaRepository
            .findByTypeAndOutboxStatusAndSagaStatusIn(
                sagaType, outboxStatus, asList(sagaStatus))
            .orElseThrow(
                () ->
