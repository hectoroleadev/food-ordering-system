...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
  ...
  public void process(RestaurantApprovalResponse restaurantApprovalResponse) {
    Optional<OrderApprovalOutboxMessage> orderApprovalOutboxMessageResponse =
        approvalOutboxHelper.getApprovalOutboxMessageBySagaIdAndSagaStatus(
            fromString(restaurantApprovalResponse.getSagaId()), SagaStatus.PROCESSING);
  ...
  public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
    ...
    paymentOutboxHelper.savePaymentOutboxMessage(
        ...
        fromString(restaurantApprovalResponse.getSagaId()));
  ...
  private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(
    ...
    Optional<OrderPaymentOutboxMessage> orderPaymentOutboxMessageResponse =
        paymentOutboxHelper.getPaymentOutboxMessageBySagaIdAndSagaStatus(
            fromString(sagaId), SagaStatus.PROCESSING);
