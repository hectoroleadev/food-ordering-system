package dev.hectorolea.food.ordering.system.order.service.messaging.publisher.kafka;
...
import dev.hectorolea.food.ordering.system.order.service.domain.config.OrderServiceConfigData;
...
public class OrderApprovalEventKafkaPublisher implements RestaurantApprovalRequestMessagePublisher {
  ...
  public void publish(
    ...
    try {
      ...
      log.error(
          "Error while sending OrderApprovalEventPayload to kafka for order id: {} and saga id: {},"
              + " error: {}",
          orderApprovalEventPayload.getOrderId(),
          sagaId,
          e.getMessage());
