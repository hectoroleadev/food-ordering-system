...
import dev.hectorolea.food.ordering.system.restaurant.service.domain.exception.RestaurantNotFoundException;
import dev.hectorolea.food.ordering.system.restaurant.service.domain.mapper.RestaurantDataMapper;
import dev.hectorolea.food.ordering.system.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import dev.hectorolea.food.ordering.system.restaurant.service.domain.outbox.scheduler.OrderOutboxHelper;
...
public class RestaurantApprovalRequestHelper {
  ...
  private final RestaurantApprovalResponseMessagePublisher
  ...
  public void persistOrderApproval(RestaurantApprovalRequest restaurantApprovalRequest) {
    ...
    log.info(
        "Processing restaurant approval for order id: {}", restaurantApprovalRequest.getOrderId());
    ...
    orderOutboxHelper.saveOrderOutboxMessage(
        ...
        fromString(restaurantApprovalRequest.getSagaId()));
  }
  ...
  private Restaurant findRestaurant(RestaurantApprovalRequest restaurantApprovalRequest) {
    ...
    restaurant
        .getOrderDetail()
        .setId(new OrderId(fromString(restaurantApprovalRequest.getOrderId())));
